          ...
          <Card className={classes.rootCard}>
            ...
            <CardContent className={classes.cardContent}>
              ...
              <div className={classes.cardInfo}>
                {displaySignUp ?
                  <Typography>Already have an account ?, <span className={classes.signUpLink} onClick={() => setdisplaySignUp(false)}>Sign In</span></Typography> :
                  <Typography>Don't have an account ?, <span className={classes.signUpLink} onClick={() => setdisplaySignUp(true)}>Sign Up</span></Typography>
                }
              </div>
            </CardContent>
